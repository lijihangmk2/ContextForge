...
def write_project(path: Path, config: ProjectConfig) -> None:
    """Write a ProjectConfig to a TOML file.

    Args:
        path: Target file path (e.g. .ctxforge/project.toml).
        config: Validated ProjectConfig instance.
    """
